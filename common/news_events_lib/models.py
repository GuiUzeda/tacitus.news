...
class NewsEventModel(BaseModel):
    ...
    bias_distribution: Mapped[dict[str, int]] = mapped_column(
        JSONB, default=dict
    )
...
class ArticleModel(BaseModel):
    ...
    event_id: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("news_events.id"), nullable=True)
    ...
    __table_args__ = (
        Index("ix_article_event_date", "event_id", "published_date"),
    )
...
class MergeProposalModel(BaseModel):
    ...
    source_article: Mapped["ArticleModel"] = relationship(foreign_keys=[source_article_id])
    target_event: Mapped["NewsEventModel"] = relationship(foreign_keys=[target_event_id])
