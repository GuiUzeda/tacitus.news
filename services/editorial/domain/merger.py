...
class NewsMergerDomain:
    ...
    def scan_and_process_event(self, session: Session, event_id: uuid.UUID) -> MergerResult:
        """
        ...
        if self._is_event_busy(session, event_id):
            return MergerResult(MergerAction.BUSY, event_id, reason="Event is processing in Enhancer")
        ...
        return MergerResult(MergerAction.SKIPPED, event_id, reason="No matches found")
